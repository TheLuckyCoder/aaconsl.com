            ...
            <ul className="navbar-nav">
                <li className="logo">
                    <a className="nav-link">
                        <span className="link-text logo-text">A&A Consl</span>
                        <svg
                            aria-hidden="true"
                            focusable="false"
                            data-prefix="fad"
                ...
                <li className="nav-item">
                    <Link href="/excel" className="nav-link">

                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="file-excel"
                             className="svg-inline--fa fa-file-excel fa-w-12" role="img"
                        ...
                        <span className="link-text">Excel</span>
                    </Link>
                </li>
